...
dictData={}
wb=openpyxl.load_workbook('ReadingExcelAndUpdatingWord2.xlsx')
...
for key,val in dictData.items():
	prepara=doc.add_paragraph('The Gamers Club, Newyork')
	prepara.style="Heading 1"
	prepara.alignment=1
	prepara.runs[0].add_break()

	prepara2=doc.add_paragraph("_______________________________________________________________________________________________________")
	prepara.alignment=1
	prepara.runs[0].add_break()
